...
///import lab.pak.com.app.Notificatio.Notificatio;
...
public class CustomAdapterConversation extends RecyclerView.Adapter<CustomAdapterConversation.MyViewHolder> {

    private final ArrayList<Messages> mainob;
   Context context;
    private MyViewHolder vh;


    public CustomAdapterConversation(Context context, ArrayList<Messages> mainob) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.conversationmodule, parent, false);
...
if(type.equals("provider")){
    holder.title.setText(mainob.get(position).username);}
else{
    holder.title.setText(mainob.get(position).providername);
}
holder.message.setText(mainob.get(position).message);
holder.time.setText(mainob.get(position).dates);
//mainob.get(position).
  holder.itemView.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            try {
                Intent op = new Intent(context, ConversationBidsUser.class);
                bids o = new bids();
                o.providerid=mainob.get(position).providerid;
                o.userid=mainob.get(position).userid;
  ...
  //              ((Notificatio)context).startprogress();
