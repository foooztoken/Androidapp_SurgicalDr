...
public class Bidshistoryorder extends AppCompatActivity {
...
// call the constructor of CustomAdapter to send the reference and data to Adapter
                                CustomAdapterbids customAdapter = new CustomAdapterbids(Bidshistoryorder.this,jobs);// address,name,amount,idd,lat,lon,phone);
                    ...
                    } catch (Exception e) {        Toast.makeText(Bidshistoryorder.this, e.toString(), Toast.LENGTH_LONG).show();
                ...
                public void onFailure(Call<List<bids>> call, Throwable t) {
                   ...
                   //         Toast.makeText(Mybids.this,"Error!Check Connection" ,Toast.LENGTH_LONG ).show();
                        ...
                        //e.printStackTrace();
                        Toast.makeText(Bidshistoryorder.this, a.toString(), Toast.LENGTH_LONG).show();
...
//        Toast.makeText(MainActivity.this,s ,Toast.LENGTH_LONG ).show();
            ...
            //e.printStackTrace();
            Toast.makeText(Bidshistoryorder.this,"Problem occuring ",Toast.LENGTH_LONG ).show();
