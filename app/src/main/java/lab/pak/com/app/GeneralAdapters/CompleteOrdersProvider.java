...
import lab.pak.com.app.MyJobsUser.CustomAdapterJobsUser;
...
public class CompleteOrdersProvider extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            finish();
            Intent o=new Intent(CompleteOrdersProvider.this, ProviderMain.class);
                            ...
                            try {
                                ...
                                if (id != null) {
                                    ...
                                    for(int i=0;i<ob.size();i++){
                                        if(id.equals(ob.get(i).providerid)) {
...
// call the constructor of CustomAdapter to send the reference and data to Adapter
                                CustomAdapterJobsUser customAdapter = new CustomAdapterJobsUser(CompleteOrdersProvider.this,jobs);// address,name,amount,idd,lat,lon,phone);
                             ...
                             /*    SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
                               ...
                               */     //      Toast.makeText(getApplicationContext(), details, Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(CompleteOrdersProvider.this, "Problem Connecting", Toast.LENGTH_LONG).show();
                            }
                        }
                ...
                public void onFailure(Call<List<Jobs>> call, Throwable t) {
                    try {
                        ...
                        //e.printStackTrace();
                        Toast.makeText(CompleteOrdersProvider.this, a.toString(), Toast.LENGTH_LONG).show();
...
//        Toast.makeText(MainActivity.this,s ,Toast.LENGTH_LONG ).show();
            ...
            //e.printStackTrace();
            Toast.makeText(CompleteOrdersProvider.this,"Problem occuring ",Toast.LENGTH_LONG ).show();
