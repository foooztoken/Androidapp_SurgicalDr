...
import lab.pak.com.app.GeneralAdapters.CustomAdapterConversationNew;
...
public class JobDetailUser extends AppCompatActivity  {
...
ProgressBar progressBar;
    private RelativeLayout jobdescr;
String de;
Button send;
...
TextView provider,statuss;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_detailuser);
   ...
   try {
    ...
    /*
            Intent i=new Intent(JobDetailUser.this,JobDetailNew.class);
               Gson gson = new Gson();
               String studentDataObjectAsAString = getIntent().getStringExtra("ob");
                jobs = gson.fromJson(studentDataObjectAsAString, Jobs.class);
               Gson gso = new Gson();
    ...
    /*
               if(jobs.status.equals("pending")){
                   Intent intent=new Intent(JobDetailUser.this,MybidsOrder.class);
                   ...
                   Toast.makeText(JobDetailUser.this,o ,Toast.LENGTH_SHORT ).show();
                   mDrawerLayout.closeDrawer(GravityCompat.START);
               }*/
...
send.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        if (jobs.status.equals("started")) {
            ...
            if (fileUri != null) {
                ...
                if (jobs.userid == null || jobs.userid.equals("")) {
                    Toast.makeText(JobDetailUser.this, "It isnt assigned yet!", Toast.LENGTH_SHORT).show();
                } else {
        ...
        }else{Toast.makeText(JobDetailUser.this,"Order is "+jobs.status ,Toast.LENGTH_SHORT ).show();}}
    ...
    showmessages(jobs.providerid,jobs.userid,jobs.id );
       ...
       Toast.makeText(JobDetailUser.this,e.toString() , Toast.LENGTH_LONG).show();
   }
...
//                            showmessages(jobs.providerid,jobs.userid,jobs.id );
            ...
            }}catch (Exception e){      progress.setVisibility(View.INVISIBLE);
...
void nullifyuri(){
    ...
    private void showSettingsAlert() {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "SETTINGS",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        openAppSettings(JobDetailUser.this);
                    }
                });
        alertDialog.show();
    }
  ...
  void sendmessage(String providerid, String userid, String jobid, String name,  String message){
        try {
            ...
            Call<Object> callPet = service.signup( "http://surapi.surgicaldr.com/Models/sendmessage.php?var="+obj);
            progress.setVisibility(View.VISIBLE);
...
//showmessages(jobs.providerid, jobs.userid,jobs.id );
                        ...
                        if (response.isSuccessful()) {
                            ...
                            try {
                                ...
                                Toast.makeText(JobDetailUser.this, "Problem Connecting", Toast.LENGTH_LONG).show();
                            }
                        }
                ...
                public void onFailure(Call<Object> call, Throwable t) {
                    try {
                      ...
                      //  Toast.makeText(getApplicationContext(),call.toString(), Toast.LENGTH_LONG).show();
                        ...
                        //e.printStackTrace();
                        Toast.makeText(JobDetailUser.this, a.toString(), Toast.LENGTH_LONG).show();
...
//        Toast.makeText(MainActivity.this,s ,Toast.LENGTH_LONG ).show();
            ...
            //e.printStackTrace();
            Toast.makeText(JobDetailUser.this,"Problem occuring ",Toast.LENGTH_LONG ).show();
...
// call the constructor of CustomAdapter to send the reference and data to Adapter
                                CustomAdapterConversationNew customAdapter = new CustomAdapterConversationNew(JobDetailUser.this,jobs);// address,name,amount,idd,lat,lon,phone);
