...
public class MyJobsUser extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            finish();
            Intent o=new Intent(MyJobsUser.this, ProviderMain.class);
...
// call the constructor of CustomAdapter to send the reference and data to Adapter
                                CustomAdapterJobsUser customAdapter = new CustomAdapterJobsUser(MyJobsUser.this,jobs);// address,name,amount,idd,lat,lon,phone);
                             ...
                             /*    SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
                               ...
                               */     //      Toast.makeText(getApplicationContext(), details, Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(MyJobsUser.this, "Problem Connecting", Toast.LENGTH_LONG).show();
                            }
                        }
                ...
                public void onFailure(Call<List<Jobs>> call, Throwable t) {
                    try {
                        ...
                        //e.printStackTrace();
                        Toast.makeText(MyJobsUser.this, a.toString(), Toast.LENGTH_LONG).show();
...
//        Toast.makeText(MainActivity.this,s ,Toast.LENGTH_LONG ).show();
            ...
            //e.printStackTrace();
            Toast.makeText(MyJobsUser.this,"Problem occuring ",Toast.LENGTH_LONG ).show();
