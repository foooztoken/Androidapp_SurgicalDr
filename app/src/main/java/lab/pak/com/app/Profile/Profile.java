...
// call the constructor of CustomAdapter to send the reference and data to Adapter
                                CustomAdapterReview customAdapter = new CustomAdapterReview(Profile.this,jobs);// address,name,amount,idd,lat,lon,phone);
                                ...
                                Toast.makeText(Profile.this, "Problem Connecting", Toast.LENGTH_LONG).show();
                            }
                        }
                ...
                public void onFailure(Call<List<Review>> call, Throwable t) {
                    try {
                       ...
                       progress.setVisibility(View.INVISIBLE);
                        ...
                        Toast.makeText(Profile.this, a.toString(), Toast.LENGTH_LONG).show();
            ...
            progress.setVisibility(View.INVISIBLE);
            Toast.makeText(Profile.this,"Problem occuring ",Toast.LENGTH_LONG ).show();
...
// set a LinearLayoutManager with default vertical orientaion
                                ...
                                recyclerView.setLayoutManager(linearLayoutManager); // set LayoutManager to RecyclerView
// call the constructor of CustomAdapter to send the reference and data to Adapter
                                CustomAdapterImages customAdapter = new CustomAdapterImages(Profile.this, images);// address,name,amount,idd,lat,lon,phone);
                                recyclerView.setAdapter(customAdapter);
                    ...
                    } catch (Exception e) {         Toast.makeText(Profile.this, e.toString(), Toast.LENGTH_LONG).show();
