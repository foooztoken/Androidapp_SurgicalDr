...
public class ConversationBidsUser extends AppCompatActivity {
...
send.setOnClickListener(new View.OnClickListener() {
    ...
    showmessages(jobs.providerid,jobs.userid,jobs.id );
       ...
       Toast.makeText(ConversationBidsUser.this,e.toString() , Toast.LENGTH_LONG).show();
   }}
...
void changelanguage(){
    ...
    if(language!=null&&language.equals("arabic")&&typee.equals("user")){
        ...
        Toolbar   toolbar=findViewById(R.id.header);
        toolbar.setTitle("محادثة");
        TextView typehere=findViewById(R.id.text);
        typehere.setHint("أكتب سؤالك هنا");
    ...
    private void showSettingsAlert() {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "SETTINGS",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        openAppSettings(ConversationBidsUser.this);
                    }
                });
        alertDialog.show();
    }
...
progress.setVisibility(View.VISIBLE);
                    ...
                    Call<ResponseBody> call = service.postFilebid(body, description,modelBody);
...
void nullifyuri(){
  ...
  void sendmessage(String providerid,String userid,String jobid,String name,String message){
        try {
            ...
            Call callPet = service.signup( "http://surapi.surgicaldr.com/Models/sendmessagebid.php?var="+obj);
            progress.setVisibility(View.VISIBLE);
...
//                        showmessages(jobs.providerid,jobs.userid,jobs.id );
                        ...
                        if (response.isSuccessful()) {
                            ...
                            try {
                             ...
                             Object ob=response.body();
                                ...
                                Toast.makeText(ConversationBidsUser.this, "Problem Connecting", Toast.LENGTH_LONG).show();
                            }
                        }
                ...
                public void onFailure(Call<Object> call, Throwable t) {
                    try {
                        ...
                        //e.printStackTrace();
                        Toast.makeText(ConversationBidsUser.this, a.toString(), Toast.LENGTH_LONG).show();
...
//        Toast.makeText(MainActivity.this,s ,Toast.LENGTH_LONG ).show();
            ...
            //e.printStackTrace();
            Toast.makeText(ConversationBidsUser.this,"Problem occuring ",Toast.LENGTH_LONG ).show();
    ...
    void showmessages(String providerid,String userid,String jobid){
        try {
            ...
            final RetrofitInterface service=retrofit.create(RetrofitInterface.class);
            Call<List<Messages>> callPet = service.getmessage( "http://surapi.surgicaldr.com/Models/showmessagebid.php?providerid="+providerid+"&employeeid="+userid+"&jobid="+jobid);
            progress.setVisibility(View.VISIBLE);
...
// call the constructor of CustomAdapter to send the reference and data to Adapter
                                CustomAdapterConversation customAdapter = new CustomAdapterConversation(ConversationBidsUser.this,jobs);// address,name,amount,idd,lat,lon,phone);
